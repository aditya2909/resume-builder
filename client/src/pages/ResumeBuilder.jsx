        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              <hr className="absolute top-0 left-0 right-0 bottom-2 border-gray-200" />
              <hr
                ...
                <div className="flex items-center">
                  {activeSectionIndex !== 0 && (
                    <button
                      ...
                      className="flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 tranistion-all"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 tranistion-all ${activeSectionIndex === sections.length - 1 && "opacity-50"}`}
